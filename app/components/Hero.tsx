    ...
    <Container className='pt-20 pb-16 text-center lg:pt-32 font-medium'>
      ...
      <div className='mt-10 flex justify-center space-x-6'>
        <button className='group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-slate-900 text-white hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900'>
          <a href='/register'>Get 6 months free</a>
        </button>
        <button
        ...
        <ul className='mt-8 flex items-center justify-center space-x-8 sm:flex-col sm:space-x-0 sm:space-y-10 xl:flex-row xl:space-y-0 xl:space-x-12'>
          <li>
            <ul className='flex flex-col items-center space-y-8 sm:flex-row sm:space-y-0 sm:space-x-12'>
              <li className='flex'>
                <img src={logoTransistor} alt='Transistor' />
              </li>
              <li className='flex'>
                <img src={logoTuple} alt='Tuple' />
              </li>
              <li className='flex'>
                <img src={logoStaticKit} alt='StaticKit' />
              </li>
            </ul>
          </li>
          <li>
            <ul className='flex flex-col items-center space-y-8 sm:flex-row sm:space-y-0 sm:space-x-12'>
              <li className='flex'>
                <img src={logoMirage} alt='Mirage' />
              </li>
              <li className='flex'>
                <img src={logoLaravel} alt='Laravel' />
              </li>
              <li className='flex'>
                <img src={logoStatamic} alt='Statamic' />
              </li>
            </ul>
          </li>
        </ul>
