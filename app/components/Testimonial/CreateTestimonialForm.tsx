                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <textarea
                          ...
                          className={`text-ellipsis w-full lg:w-[22rem] block rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ${error
                    ...
                    <div className="mt-6">
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm ${error1
                            ? 'border border-red-600 focus:border-red-500 focus:ring-red-500'
                            : 'focus:border-indigo-500 focus:ring-indigo-500'
                            }`}
                        />
