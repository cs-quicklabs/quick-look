      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className={`pointer-events-none fixed inset-y-0 left-0 flex `}>
          <div className="pointer-events-auto w-screen max-w-md">
            <div>
              <div
                className={`flex h-[95%] flex-col mt-12 bg-white font-inter border-r border-gray-200 overflow-y-auto ${mode === 'mobile'
                ...
                <Form replace={true} action="add/socialProfile" method="post">
                  <div className="pl-2.5 pr-5 mt-6">
                    <Combobox
                      ...
                      onChange={setSelectedSocialLinks}
                    >
                    ...
                    <div className="mt-5">
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className={` leading-5 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm text-gray-900 ${error
