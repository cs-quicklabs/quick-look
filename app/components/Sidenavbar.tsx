...
const navigation: nav = [
  ...
  { name: 'Support',class :'hover:bg-white text-gray-500 hover:text-gray-500 font-[600] text-[12px]'},
  { name: 'Help Center', href: '#',current: false},
  { name: 'Terms of Use', href: '#',current: false},
  { name: 'Privacy Policy', href: '#',current: false},
  { name: 'Refund Policy', href: '#',current: false},
]
...
//     <div className="flex flex-col flex-grow pt-5 pb-4 bg-white overflow-y-auto h-screen p-12 w-[30%] ">
...
//                 item.current ? 'bg-gray-100 text-gray-900' : item.class ? item.class :'text-gray-600 hover:bg-gray-50 hover:text-gray-900',
