...
export default function Template16({
  ...
  return (
    ...
    ${
      ...
      >
        <div
          className={`flex-shrink-0 flex flex-col justify-start items-start h-[25rem] ${
            mode === 'mobile'
        ...
        <div
          className={`flex flex-col justify-center items-center w-[90%] px-[1rem] ${
            mode === 'mobile' ? '' : 'xl:pt-[7rem]'
          } ${
            nav
        ...
        >
          <div className={`w-full ${mode === 'mobile' ? '' : 'xl:rounded-none xl:shadow-none'}`}>
            ...
            loaderData?.profileInfo?.location ? (
              <h3
                className={`text-white text-left break-normal text-xs leading-5 font-normal lg:text-base ${
                  mode === 'mobile'
                    ? ''
            ...
            <div
              className={`pb-[1rem] w-full ${
                mode === 'mobile' ? '' : 'lg:bg-transparent xl:hidden'
              } `}
            >
              <div
                className={`flex pt-4 justify-between flex-col ${
          ...
          <div
            className={`pb-[1rem] w-full hidden ${
              mode === 'mobile' ? 'xl:mt-[-1rem]' : 'lg:bg-transparent xl:block'
            } `}
          >
            <div
              className={`flex pt-[2rem] justify-between flex-col ${
                mode === 'mobile' ? '' : 'xl:flex-col xl:pt-[1.5rem]'
              } ${nav ? '' : ''}`}
            >
              {loaderData?.profileInfo?.company || input.company ? (
