    ...
    <>
      ...
      <div
        className={`lg:pl-[0.1rem] flex overflow-auto scrollbar-hide ${
          ...
          mode === 'mobile'
            ? 'flex-col'
            : 'flex-col pt-[3rem] pb-[5rem] lg:gap-[8rem] xl:flex-row'
      ...
      >
        ...
        <div
          className={`lg:mt-[1.5rem] pl-[1rem] pr-[2rem] w-full ${
            mode === 'mobile'
              ? ''
              : 'xl:w-[30rem] mediumLaptop:w-[35rem] largeLaptop:w-[40rem]'
          } ${
            nav
              ? 'xl:w-[35rem] mediumLaptop:w-[40rem] largeLaptop:w-[45rem]'
              : ''
          }`}
        >
          <h4
          ...
          loaderData?.profileInfo?.location ? (
            <h3
              className={`text-gray-500 text-center break-normal text-xs leading-5 font-normal lg:text-2xl lg:leading-8 lg:font-medium ${
                mode === 'mobile'
                  ? ''
                  : 'lg:text-start xl:w-max mediumLaptop:w-full'
              }  ${nav ? 'xl:w-full' : ''} `}
            >
              {input.occupation}{' '}
          ...
          <div>
            <div
              className={` text-center ${mode === 'mobile' ? '' : ''} ${
                nav ? '' : ''
              }`}
            >
          ...
          <div
            className={`mb-10 ${mode === 'mobile' ? '' : ''} ${nav ? '' : ''}`}
          >
            {loaderData?.spotlightButton?.toggleSpotlight && (
            ...
            >
              ...
              >
                {loaderData?.profileInfo?.company || input.company ? (
                  <div
                    className={`flex lg:w-[50%] ${mode === 'mobile' ? '' : ''}`}
                  >
                    <h2
          ...
          <div
            className={`${
              loaderData?.portfolioImage.length > 1 ? 'pt-[4rem]' : 'pt-[0rem]'
            } ${mode === 'mobile' ? '' : ''} ${nav ? '' : ''}`}
          >
