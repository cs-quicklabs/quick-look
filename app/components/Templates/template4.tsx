 ...
 const nav = Location.pathname.includes(`${loaderData.username}`)
  ...
  return(
    ...
    <div className={`flex overflow-auto scrollbar-hide bg-purple-50 ${nav ?'min-h-[calc(96.5vh+50px)] ' : 'min-h-[calc(95.5vh+50px)] '} ${mode ==='mobile' ? 'largeLaptop:bg-white flex-col-reverse flex-col largeLaptop:flex-row ' : 'xl:bg-white flex-col-reverse xl:flex-row flex-col xl:flex-row pt-[2rem] lg:pt-[5rem]'}  justify-center bg-no-repeat object-cover overflow-none`}>
      ...
      <div className={`mt-[1rem] sm:mt-[2rem] xl:mt-[5.625rem] pt-[1rem] bg-white ${mode ==='mobile' ? 'sm:ml-[4rem] lg:ml-[2rem] 2xl:ml-0 largeLaptop:mr-[1rem]  p-[3rem] lg:pl-[3rem] xl:pl-[10.5rem] medium:pl-[14rem] largeLaptop:pl-[22rem] large:pl-[0rem] 2xl:pl-[4rem]' : 'pl-[3rem] sm:pl-[9rem] xl:pl-[7rem] sm:pl-[6rem] lg:pl-[15rem] xl:p-[0rem]'} ${nav ? 'lg:pl-[10rem] lg:pr-[8rem] lg:pl-[9rem]' :''}`}>
        ...
        <div className="mt-1 ">
          <pre className={`text-gray-700 text-base leading-5 font-normal font-sans flex whitespace-pre-wrap text-justify ${mode ==='mobile' ? '' : 'pr-[3rem] sm:pr-[6rem] lg:pr-[2rem] xl:pr-0 2xl:pr-[4rem] sm:ml-[-7rem] xl:ml-[1rem] 2xl:ml-[2.5rem]'} ${nav ? 'pr-[6rem] lg:pr-[8rem] medium:pr-[5rem] medium:ml-[2.5rem] largeLaptop:ml-[3rem] 2xl:pr-[14rem] 2xl:ml-[9.5rem] large:pr-[32rem]' : ''}`}>
              { input?.description?.trim()}
            </pre>
        </div>

        <div className={` flex flex-col ${mode ==='mobile' ? '' : 'pr-[3rem] sm:pr-[6rem] lg:pr-[2rem] xl:pr-0 2xl:pr-[4rem] sm:ml-[-7rem] xl:ml-[1rem] 2xl:ml-[2.5rem]'} ${nav ? 'sm:ml-[2rem] md:ml-[-7rem] lg:ml-[2rem] lg:pr-[10rem] medium:ml-[2.5rem] largeLaptop:ml-[3rem] 2xl:ml-[9.5rem]' : ''}`}>
      ...
      <div className={`mb-4 flex-shrink-0 sm:mb-0 xl:mt-[5.625rem] pr-[2rem] sm:pr-[6rem] w-[65%] ${mode ==='mobile' ? 'lg:ml-[9rem] xl:ml-[14.5rem] medium:ml-[16rem] largeLaptop:ml-[0rem] lg:pr-0 2xl:mr-[2rem] large:mr-[0rem] xl:pl-0 medium:pl-0 medium:max-w-[60rem] largeLaptop:max-w-[45rem] lg:max-w-[20rem] xl:max-w-[35rem] 2xl:max-w-[38rem]' : 'pl-[3rem] lg:pr-[5rem] xl:pr-0 medium:pl-0 xl:mr-[2rem] lg:max-w-7xl xl:max-w-[32rem] ml-[3rem] sm:ml-[5.5rem] md:ml-[6.5rem] lg:ml-[5.7rem] lg:w-[86%] xl:w-[39%] 2xl:ml-[2rem] xl:pl-[0rem] sm:pl-[6rem] lg:pl-[8rem] xl:p-[0rem]'} ${nav ? 'xl:pl-[2rem] 2xl:pl-0 lg:w-[47rem] xl:max-w-[35rem] lg:pr-[8rem] lg:pl-[7rem] lg:ml-[5.7rem]' : 'xl:pl-0 2xl:pl-[6rem]'}`} >
