  ...
  const nav = Location.pathname.includes(`${loaderData.username}`)
  {
    ...
    return (
      <>
        ...
        <div
          className={`flex flex-col-reverse items-end ml-[0.1rem] pb-[3rem] ${mode === 'mobile' ? '' : 'xl:flex-row xl:items-start xl:justify-between'
            } ${nav ? '' : ' '}`}
        >
          <div
            className={`w-full px-[2rem] mt-[3rem] h-full ${mode === 'mobile'
              ? 'lg:px-[3rem]'
          ...
          >
            <h4
              className={`text-xl leading-8 font-semibold text-black lg:text-4xl lg:leading-10 lg:font-extrabold lg:text-gray-800 ${mode === 'mobile' ? '' : ''
                } ${nav ? '' : ''}`}
            >
            ...
            {loaderData?.profileInfo?.occupation ||
              ...
              <h3
                className={`text-xs leading-5 font-normal text-gray-500 lg:text-2xl lg:leading-8 lg:font-medium lg:text-gray-600 ${mode === 'mobile' ? '' : ''
                  }  ${nav ? '=' : ''} `}
              >
            ...
            <div className="mt-1">
              <pre
                className={`text-gray-700 text-xs lg:text-base leading-5 font-normal font-sans flex whitespace-pre-wrap text-justify ${mode === 'mobile' ? '' : ''
                  } ${nav ? '' : ''}`}
              >
            ...
            <div>
              <div
                className={`flex flex-col pt-4 ${mode === 'mobile' ? '' : 'xl:flex-row lg:justify-between'
                  }  ${nav ? '' : ''}`}
              >
                {loaderData?.profileInfo?.company || input.company ? (
                  <div className={`flex  ${mode === 'mobile' ? '' : ''}`}>
                    <h2
                      className={`text-gray-900 font-medium text-base leading-5 w-[1.125rem] mr-[1.18rem] lg:text-gray-800 ${mode === 'mobile' ? '' : ''
                        }`}
                    >
                      <BriefcaseIcon />
                    </h2>
                    ...
                    <h2
                      className={`text-gray-600 w-max text-xs leading-5 lg:text-base lg:leading-6 font-normal break-normal ${mode === 'mobile' ? '' : 'lg:mt-[-0.25rem] xl:w-[65%] largeLaptop:w-max'
                        }  ${nav ? '' : ''}`}
                    >
                      {input.company}
                    </h2>
                ...
                {loaderData?.profileInfo?.education || input.education ? (
                  <div className={`flex mt-[0.75rem] ${mode === 'mobile' ? '' : ' xl:mt-0'}`}>
                    ...
                    <h2
                      className={`text-gray-600 w-max text-xs leading-5 lg:text-base lg:leading-6 font-normal break-normal ${mode === 'mobile' ? '' : 'lg:mt-[-0.25rem]'
                        }  ${nav ? '' : ''}`}
                    >
                      {input.education}
                    </h2>
            ...
            <footer
              className={`flex w-full gap-4 md:gap-8 justify-start  ${nav ? '' : ''} ${loaderData?.portfolioImage[0] ? 'pt-[2rem]' : 'pt-[0rem]'
                }`}
            >
          ...
          <div
            className={`flex py-[2rem] pr-4 sm:w-[33rem] md:w-[38rem] ${mode === 'mobile'
          ...
          >
            {secondaryRestore || loaderData?.profileImage?.secondaryImage ? (
              <img
                loading="lazy"
                className={`relative rounded-full shadow-xl object-cover h-[20rem] w-[20rem] sm:h-[30rem] sm:w-[30rem] md:h-[35rem] md:w-[35rem] ${mode === 'mobile'
                  ...
                  } ${nav ? 'SmMedium:w-[30rem] SmMedium:h-[30rem]' : ''} ${loaderData?.profileImage?.secondaryImage || secondaryRestore === true ? '' : ''
                  }  `}
                src={
