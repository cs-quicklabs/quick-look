...
export default function Spotlightbtn({ loaderData }: any) {
  ...
  return (
    <div className={`flex justify-center items-center mb-[2rem] ${loaderData?.profileInfo?.templateNumber == '2' || loaderData?.profileInfo?.templateNumber == '3' || loaderData?.profileInfo?.templateNumber == '4' || loaderData?.profileInfo?.templateNumber == '7' || loaderData?.profileInfo?.templateNumber == '8' || loaderData?.profileInfo?.templateNumber == '11' ? 'mt-[2rem]' : 'mt-9' }`} >
