...
export default function Spotlightbtn({ loaderData }: any) {
  ...
  return (
    <div className='flex justify-center items-center mt-9 mb-4'>
      <a href={loaderData?.spotlightButton?.buttonActionlink.includes('https') ? loaderData?.spotlightButton?.buttonActionlink : 'https://'+loaderData?.spotlightButton?.buttonActionlink} target="_blank">
