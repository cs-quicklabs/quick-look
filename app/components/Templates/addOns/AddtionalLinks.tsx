...
export default function AdditionalLinksAddOn({ loaderData }: any) {
  ...
  return (
    <div>
      ...
      <div className={`flex justify-center items-center ${loaderData?.profileInfo?.templateNumber == '2' || loaderData?.profileInfo?.templateNumber == '4' || loaderData?.profileInfo?.templateNumber == '7' || loaderData?.profileInfo?.templateNumber == '8' || loaderData?.profileInfo?.templateNumber == '11' || loaderData?.profileInfo?.templateNumber == '13' ? 'mb-[2rem]' : 'mt-9 mb-4' }`} >
