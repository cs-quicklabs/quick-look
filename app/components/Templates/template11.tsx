 ...
 const nav = Location.pathname.includes(`${loaderData.username}`)
  ...
  return(
    ...
    <div className={`relative flex overflow-auto scrollbar-hide font-inter bg-white overflow-none pb-[3rem] ${nav ?'min-h-[calc(96.5vh+50px)]' : 'min-h-[calc(95.5vh+50px)]'} ${mode ==='mobile' ? 'flex-col' : 'flex-col xl:gap-[4rem] xl:flex-row xl:items-start xl:justify-start'} ${nav? '' :''}`} >
      ...
      ${(mode === 'mobile') && (loaderData?.socialMedia?.facebookLink || loaderData?.socialMedia?.twitterLink || loaderData?.socialMedia?.youtubeLink) ? 'lg:mt-[-4rem] SmMedium:mt-[-4.5rem] med:mt-[-4.5rem] medium:mt-[-4.5rem] mediumLaptop:mt-[-4.5rem] largeLaptop:mt-[-4.5rem]' : mode === 'mobile' ? 'lg:mt-[-4.5rem] xl:mt-[-6rem] med:mt-[-5.5rem] mediumLaptop:mt-[-5.5rem] largeLaptop:mt-[-3.5rem]' : (mode != 'mobile' || loaderData?.socialMedia?.facebookLink) || (mode != 'mobile' || loaderData?.socialMedia?.twitterLink) || (mode != 'mobile' || loaderData?.socialMedia?.youtubeLink) ? 'mt-[-6rem] sm:mt-[-5.5rem] md:mt-[-11.5rem] lg:mt-[-11rem] xl:mt-[18rem] medium:mt-[21rem] mediumLaptop:mt-[21rem] largeLaptop:mt-[23.5rem]' : mode != 'mobile' ? 'mt-[-10rem] sm:mt-[-10rem] lg:mt-[-8rem] xl:mt-[18rem] medium:mt-[21rem] mediumLaptop:mt-[21rem] largeLaptop:mt-[23.5rem]' : '' } 
      `}>
