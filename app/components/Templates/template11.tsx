...
export default function Template11({
  ...
  return (
    <>
      ...
      <div
        className={`flex overflow-auto scrollbar-hide font-inter bg-white overflow-none pb-[3rem] ${nav ? 'min-h-[calc(96.5vh+50px)]' : 'min-h-[calc(95.5vh+50px)]'
          } ${mode === 'mobile' ? 'flex-col' : 'flex-col xl:gap-[4rem]'} ${nav ? '' : ''}`}
      >
        <div
          className={`flex-shrink-0 flex flex-col relative ${mode === 'mobile' ? 'w-full ' : ''} ${nav ? '' : ''
            }`}
        >
          <div className="">
            {primaryRestore || loaderData?.profileImage?.primaryImage ? (
              <img
                ...
                className={`absolute w-[100%] object-cover ${(mode === 'mobile' && loaderData?.socialMedia?.facebookLink) ||
          ...
          <div className={`flex flex-col items-center`}>
            <div
              className={`absolute flex flex-col items-center ${primaryRestore || loaderData?.profileImage?.primaryImage
                ? ` ${mode === 'mobile'
                  ? 'top-[1rem]'
            ...
            >
              {secondaryRestore || loaderData?.profileImage?.secondaryImage ? (
                <img
                  loading="lazy"
                  className={`rounded-full object-cover w-[7rem] h-[7rem] ${mode === 'mobile'
              ...
              <h4
                className={`text-white text-center text-xl leading-8 font-semibold pt-[1rem] ${mode === 'mobile'
                  ? ''
              ...
              {loaderData?.profileInfo?.occupation ||
                ...
                <h3
                  className={`mt-1 text-white text-center break-normal text-xs leading-5 font-normal lg:text-base ${mode === 'mobile'
                    ? ''
              ...
              <div
                className={`pb-[1rem] w-screen px-[1rem] ${mode === 'mobile' ? 'lg:px-[18rem] xl:px-[25rem] medium:px-[27rem]' : 'xl:hidden'
                ...
                <div className={`flex pt-4 justify-between ${mode === 'mobile' ? '' : ''}`}>
                  {loaderData?.profileInfo?.company || input.company ? (
                    <div className={`flex flex-col ${mode === 'mobile' ? '' : 'xl:flex-row'}`}>
                      <h2
                        className={`text-white text-xs leading-5 font-normal w-max ${mode === 'mobile' ? '' : 'xl:hidden'
                          }`}
                      >
                        Work
                      </h2>
                      <h2
                        className={`text-black font-medium text-sm leading-5 w-[1.125rem] mr-[0.5rem] hidden ${mode === 'mobile' ? '' : 'xl:block'
                          }`}
                      >
                        <BriefcaseIcon />
                      </h2>
                      <h2
                        className={`text-white text-xs leading-5 font-normal w-max ${mode === 'mobile'
                          ? 'lg:text-sm'
                  ...
                  {loaderData?.profileInfo?.education || input.education ? (
                    <div
                      className={`flex flex-col ${mode === 'mobile' ? '' : 'xl:flex-row'} ${nav ? '' : ''
                        }`}
                    >
                      <h2
                        className={`text-white text-xs leading-5 font-normal w-max  ${mode === 'mobile' ? '' : 'xl:hidden'
                      ...
                      <h2
                        className={`text-white w-max text-xs leading-5 font-normal break-normal  ${mode === 'mobile'
                          ? 'lg:text-sm'
                          : 'lg:text-sm xl:text-gray-600 lg:mt-[-0.15rem]'
                          }`}
                      >
              ...
              <footer
                className={`flex w-full gap-4 md:gap-8 justify-center pb-[3rem] xl:pt-6 ${nav ? '' : ''
                  } `}
              >
      ...
      `}
        >
          ...
          <div
            className={`px-[1rem] ${mode === 'mobile' ? 'lg:px-[2rem] xl:px-[3rem]' : 'lg:px-[2rem]'
              }`}
          >
            <pre
              className={`text-gray-700 text-xs leading-5 font-normal break-normal font-sans flex text-justify whitespace-pre-wrap lg:text-base ${mode === 'mobile' ? '' : ''
                } ${nav ? '' : ''}`}
            >
            ...
            <div
              className={`pb-[1rem] pr-[3rem] w-full hidden ${mode === 'mobile' ? 'xl:mt-[-1rem]' : 'xl:pl-[0rem] xl:block'
                } `}
            >
              <div
