...
export default function Template14({
  ...
  return (
    <>
      ...
      <div
        className={`flex overflow-auto scrollbar-hide font-inter bg-white justify-center overflow-none pb-[1rem] ${nav ? 'min-h-[calc(96.5vh+50px)]' : 'min-h-[calc(95.5vh+50px)]'
          } ${mode === 'mobile' ? 'flex-col' : 'flex-col'} ${nav ? '' : ''}`}
      >
        <div
          className={`relative flex flex-col ${mode === 'mobile' ? 'w-full ' : ''} ${nav ? '' : ''
            }`}
        >
          <div className="">
            {primaryRestore || loaderData?.profileImage?.primaryImage ? (
              <img
                ...
                className={`max-h-[277px] w-[100%] object-cover ${mode === 'mobile'
          ...
          <div
            className={`flex justify-center items-center ${mode === 'mobile' ? '' : 'xl:items-start xl:justify-start'
              }`}
          >
            <div
              className={`absolute ${primaryRestore || loaderData?.profileImage?.primaryImage
            ...
            >
              {secondaryRestore || loaderData?.profileImage?.secondaryImage ? (
                <img
                  loading="lazy"
                  className={`rounded-lg object-cover w-[10rem] h-[10rem] md:w-[12rem] md:h-[12rem] ${mode === 'mobile'
        ...
        <div
          className={`shadow-xl rounded-lg flex flex-col justify-center items-center w-[90%] mt-[16rem] mx-[1rem] px-[1rem] sm:w-[95%] md:mt-[20rem] ${mode === 'mobile'
        ...
        >
          <div
            className={`${mode === 'mobile' ? '' : 'xl:border-b-[1px] xl:border-gray-300 xl:pb-[1rem]'
              }`}
          >
            <h4
              className={`text-black text-center text-2xl leading-8 font-bold ml-[0rem] sm:ml-0 pt-[1rem] ${mode === 'mobile' ? '' : 'xl:text-left xl:text-4xl xl:font-extrabold xl:leading-10 '
                }  ${nav ? '' : ''}`}
            >
            ...
            {loaderData?.profileInfo?.occupation ||
              ...
              <h3
                className={`mt-1 text-gray-600 text-center break-normal text-xs leading-5 font-normal lg:text-base ${mode === 'mobile'
                  ? ''
          ...
          <div
            className={`pb-[1rem] w-full  ${mode === 'mobile' ? 'xl:mt-[-1rem]' : 'xl:hidden xl:pl-[0rem]'
              } `}
          >
            <div
              className={`flex pt-4 justify-between ${mode === 'mobile' ? '' : 'xl:flex-col xl:pt-[1.5rem]'
                } ${nav ? '' : ''}`}
            >
              {loaderData?.profileInfo?.company || input.company ? (
                <div className={`flex ${mode === 'mobile' ? '' : ''}`}>
                  <h2
                    className={`text-gray-900 font-medium text-base leading-5 w-[1.125rem] mr-[0.5rem] ${mode === 'mobile' ? '' : 'xl:text-black'
                      }`}
                  >
                    <BriefcaseIcon />
                  </h2>
                  <h2
                    className={`text-gray-800 w-[70%] sm:w-max  text-xs leading-5 font-normal break-normal   ${mode === 'mobile'
                      ? 'lg:text-sm'
              ...
              {loaderData?.profileInfo?.education || input.education ? (
                ...
                >
                  ...
                  <h2
                    className={`text-gray-800 w-max text-xs leading-5 font-normal break-normal  ${mode === 'mobile'
                      ? 'lg:text-sm'
          ...
          <pre
            className={`text-gray-700 text-xs leading-5 font-normal break-normal font-sans flex text-justify whitespace-pre-wrap lg:text-base xl:mt-[1.5rem] ${mode === 'mobile' ? '' : ''
              } ${nav ? '' : ''}`}
          >
          ...
          <div
            className={`pb-[1rem] w-full hidden ${mode === 'mobile' ? 'xl:mt-[-1rem]' : 'xl:block'
              } `}
          >
            <div
              className={`flex pt-4 justify-between ${mode === 'mobile' ? '' : 'xl:flex-col xl:pt-[1.5rem]'
            ...
            >
              {loaderData?.profileInfo?.company || input.company ? (
                <div className={`flex ${mode === 'mobile' ? '' : ''}`}>
                  ...
                  <h2
                    className={`text-gray-800 w-[65%] md:w-max lg:w-[65%] text-xs leading-5 font-normal break-normal   ${mode === 'mobile'
                      ? 'lg:text-sm'
                      : 'lg:text-sm lg:text-gray-600 lg:mt-[-0.15rem] xl:w-max'
                      }`}
                  >
          ...
          <div className="">
            ...
            <div className="">
              ...
              <footer
                className={`flex w-full gap-4 md:gap-8 justify-start pb-[2rem] ${nav ? '' : ''} ${loaderData?.portfolioImage ? 'pt-[2rem]' : 'pt-[0rem]'
                  }`}
              >
