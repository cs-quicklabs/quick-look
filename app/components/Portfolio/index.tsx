        ...
        <div className={`pointer-events-none fixed inset-y-0 left-0 flex w-96`}>
          <div className="pointer-events-auto w-screen max-w-md">
            <div className="h-screen">
              <div
                className={`font-inter mt-12 flex overflow-y-auto ${loaderData.portfolioImage.length <= 12 ? 'h-full' : 'h-[100vh]'
                  }   flex-col border-r border-gray-200 bg-white ${mode === 'mobile'
              ...
              >
                ...
                <div
                  className={`relative ${(navigation.state != 'idle' && edit) || (navigation.state != 'idle' && del)
                    ? 'opacity-30'
                    : null
                    }`}
                >
