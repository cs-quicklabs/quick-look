...
export default function DeletePortfolioImage({
  open,
  onClose,
  id,
  setShow,
            ...
            >
              <Dialog.Panel className="relative bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full sm:p-6">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete this image? Deleting
                        this means it will be removed from your public profile.
                        You can also select a different image if you want to.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="mt-5 sm:mt-4 sm:ml-10 sm:pl-4 sm:flex">
                  <Form
                    replace={true}
                    action="/account/delete/portfolioImage"
                    method="post"
                  >
                    <input
                      name="portfolioImage"
