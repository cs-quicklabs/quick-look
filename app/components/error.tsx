        ...
        <main className="flex-grow flex flex-col justify-center max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-16">
            <div className="text-center">
              ...
              <div className="mt-6">
                <Link to="/" className="text-base font-medium text-indigo-600 hover:text-indigo-500">Try Again<span aria-hidden="true" onClick={() => window.location.reload()}> &rarr;</span></Link>
              </div>
            </div>
          </div>
        </main>
