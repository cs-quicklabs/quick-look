  ...
  return (
    <div className="relative z-20">
      <div className="absolute inset-0 overflow-hidden">
        <div
          className={`pointer-events-none fixed inset-y-0 left-0 flex  mt-[3rem]  ${mode === 'mobile' ? 'lg:ml-[16rem] xl:ml-[24rem] w-[16rem] xl:w-96' : 'lg:w-96'
            }`}
        >
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <textarea
                        ...
                        className={`text-ellipsis text-gray-900 w-full lg:w-[22rem] block rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ${error
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm text-gray-900 ${error1
                          ? 'border border-red-600 focus:border-red-500 focus:ring-red-500'
                          : 'focus:border-indigo-500 focus:ring-indigo-500'
                          }`}
                      />
