...
const TrialStatus = ({
  ...
  return (
    <div
      className={`mx-1 md:mx-3 lg:mx-5 flex items-center justify-center bg-yellow-100 py-0.5 px-3 rounded`}
    >
      <span className="text-sm font-medium text-[#92400E]">
        You have {daysLeft} in trial.{' '}
