...
export default function ExistingSpotlightLink({
  ...
  return (
    <div className={`pl-3 pr-3.5 border-t border-gray-200`}>
      <ul>
                    ...
                    <div className="flex">
                      ...
                      >
                        ...
                        <DeleteSpotlight
                          ...
                          openDeleteSpotlight={openDeleteSpotlight}
                          onClose={() => setOpenDeleteSpotlight(false)}
                        />
                      </div>
                    </div>
