...
export default function CreateSpotlight({
  ...
  const getSelectedAction = () => {
    selectedAction = people.filter(
      (action) => action.name === loaderData?.spotlightButton?.buttonAction
    )
  }
  ...
  const [val, setVal] = useState({
    ...
    buttonActionlink: loaderData?.spotlightButton?.buttonActionlink || '',
    hexcode: loaderData?.spotlightButton?.buttonhex || '',
    spotlightIcon: loaderData?.spotlightButton?.spotlightIcon || '',
    buttonAction: loaderData?.spotlightButton?.buttonAction || '',
    toggleSpotlight: loaderData?.spotlightButton?.toggleSpotlight || '',
  })
        ...
        <div className={`pointer-events-none fixed inset-y-0 left-0 flex `}>
          <div className="pointer-events-auto w-screen max-w-md">
            <Form replace={true} action="add/spotlight" method="post" className="h-screen">
              <div
                className={`flex h-[95%] flex-col mt-12 divide-y divide-gray-200 bg-white font-inter border-r border-gray-200 ${mode === 'mobile'
                    ...
                    <div className="flex items-center justify-between">
                      <div className="text-lg font-medium text-gray-900 leading-7">
                        {`${loaderData?.spotlightButton?.buttonText
                          ? 'Edit Spotlight Button on your profile'
                    ...
                    <div className="divide-y divide-gray-200 px-4 sm:px-6">
                      <div className="space-y-6 pt-6 pb-5">
                        <div>
                          ...
                          <div className="mt-1">
                            <input
                              ...
                              className={`block w-full rounded-md border-gray-300 shadow-sm  sm:text-sm ${click && error
                            ...
                            >
                              ...
                              <div className="mt-1 p-1">
                                <input
                                  ...
                                  className={`block w-full rounded-md shadow-sm sm:text-sm ${click && errorHex
                        ...
                        <div>
                          ...
                          >
                            {' '}
                            {selected.name === 'Download a File'
                              ? 'Please provide download path of file which you want visiter to download'
                              : selected.name === 'Accept Payments'
                                ? 'Please enter your Payment Gateway link'
                                : selected.name === 'Let people email me'
                                  ? 'Please Enter your Email Id'
                                  : selected.name === 'Redirect to another URL'
                          ...
                          <div className="mt-1">
                            <input
                              ...
                              className={`block w-full rounded-md border-gray-300 shadow-sm  sm:text-sm ${click && errorLink
                                ? 'border-red-500 focus:border-red-500 focus:ring-red-500'
                                : 'focus:border-indigo-500 focus:ring-indigo-500'
                                }`}
                            />
