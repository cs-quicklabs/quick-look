...
const [selectedColor, setSelectedColor] = useState(loaderData?.profile?.additionalLinksColor || '')
            ...
            <div className="flex flex-shrink-0 justify-end mt-7">
              ...
              <div className="flex flex-shrink-0 justify-end pl-4 pb-2 mt-7">
                    ...
                    onClick={(e:any)=>{setClicked(true);
                      val.linkText === '' || val.linkUrl === '' || (!input.linkHex && !selectedColor) ? e.preventDefault() : null
                    }}
