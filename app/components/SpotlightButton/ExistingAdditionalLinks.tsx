...
export default function ExistingAdditionalSpotlightLink({
  ...
  const [clickedAdditionalSpotlight, setClickedAdditionalSpotlight] = useState<{
    linkText: any
    id: any
    linkUrl: any
  }>({ linkText: '', id: '', linkUrl: '' })
    ...
    >
      <ul>
        {loaderData?.additionalLinks.map(
          (additionalSpotlight: { linkText: any; id: any; linkUrl: any }) => (
                      ...
                      >
                        ...
                        >
                          <button
                            ...
                            onClick={(e: any) => {
                              e.preventDefault()
                              toggleEditAdditionalLink(additionalSpotlight)
                            }}
                          >
                            Edit
                          </button>
