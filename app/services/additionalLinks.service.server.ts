...
import type { AddAdditionalLink } from '~/types/additionalLink.server'

export async function addAdditionalLink({
  linkText,
  linkColor,
  linkUrl,
  linkHex,
...
export async function updateAdditionalLink(
  { linkText, linkColor, linkUrl, linkHex, user }: AddAdditionalLink,
  linkId: string
) {
