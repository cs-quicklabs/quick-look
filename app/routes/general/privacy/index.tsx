                  ...
                  <div className="text-sm text-slate-600 outline-none">
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      ...
                      <p className="text-slate-600 text-[14px]">
                        ...
                        we collect from you when you and why. If you have any questions after
                        reading this Privacy Statement, feel free to contact us at
                        admin@quicklook.me
                      </p>
                      <p className="text-slate-600 text-[14px]">
                        To avoid any misunderstandings, we would like to clarify that this Privacy
                        Statement is applicable on processing of personal data from: Account
                    ...
                    <p>
                      <p className="mt-2 text-slate-600 text-[14px]">
                        Electronical identification data: including IP address, device &amp; browser
                        data, location data
                      </p>
                      Information about your use of our website: including how you end up on our
                      website, the pages you visited, the way in which you navigate on these web
                      pages, the duration of the visit. Since we rely on the use of cookies for
                      processing the above mentioned data, please refer to our Cookie Statement for
                      more information.
                      <p className="text-slate-600 text-[14px]">Registration information </p>
                      When you register for an account, we collect your first and last name,
                      username, password and email address.
                      <p className="">Billing information </p>If you have paid subscrption, that
                      subscription is managed through Stripe and we do not store any billing
                      information.
                    </p>
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 ">
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      ...
                      <p className="text-slate-600 text-[14px]">Deliver our services to you </p>
                      <p className="text-slate-600 text-[14px]">To improve your user experience</p>
                      <p className="text-slate-600 text-[14px]">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 ">4. Data we share</h2>
                    <p className="mt-2 text-slate-600 text-[14px]">
                      We only share your information with our service providers who help us operate
                      our business, in which case those third parties are required to comply with
                      the GDPR framework.
                    </p>
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 ">
                      5. Data retention
                    ...
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6">7. Marketing</h2>
                    <p className="mt-2 text-slate-600 text-[14px]">
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      We can make changes to this Privacy Policy from time to time. In circumstances
                      where a change will materially change the way in which we collect or use your
                      personal information or data, we will send a notice of this change to all of
                      our account holders. We keep our privacy policy under regular review and will
                      place any updates on this web page.
                    </p>
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 "> 10. Contact</h2>
                    <p className="mt-2 text-slate-600 text-[14px]">
