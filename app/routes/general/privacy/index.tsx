              ...
              <div className=' h-full '>
                <div className=' relative inset-0 border-gray-200 rounded-lg'>
                  ...
                  <p>
                    ...
                    Information about your use of our website: including how you
                    end up on our website, the pages you visited, the way in
                    which you navigate on these web pages, the duration of the
                    visit. Since we rely on the use of cookies for processing
                    the above mentioned data, please refer to our Cookie
                    Statement for more information.
                    <p className='text-slate-600 text-[14px]'>Registration information </p>When you register for an
                    account, we collect your first and last name, username,
                    password and email address.<p className=''>Billing information </p>If you
                  ...
                  <p className='mt-2 text-slate-600 text-[14px]'>
                    ...
                    <p className='text-slate-600 text-[14px]'>To email you with essential product updates</p>
                    <p className='text-slate-600 text-[14px]'>To troubleshoot product functionality and fix bugs</p>
                    <p className='text-slate-600 text-[14px]'>To respond to legal requests or prevent fraud</p>
                  </p>
                  <h2 className='text-2xl font-semibold text-gray-800 mt-6 '>
                    4. Data we share
                  </h2>
                  ...
                  <p className='mt-2 text-slate-600 text-[14px]'>
                    ...
                    or data, we will send a notice of this change to all of our
                    account holders. We keep our privacy policy under regular
                    review and will place any updates on this web page.
                  </p>
                  <h2 className='text-2xl font-semibold text-gray-800 mt-6 '>
                    {' '}
                    10. Contact
