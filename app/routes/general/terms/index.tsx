                ...
                <div className=" border-gray-200 rounded-lg">
                  ...
                  <div className="text-sm text-slate-600 outline-none">
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      ...
                      whether personally or on behalf of an entity (“you”) and Crownstack
                      ("Company", “we”, “us”, or “our”), concerning your access to and use of the
                      https://quicklook.me website as well as any other media form, media channel,
                      ...
                      have read, understood, and agree to be bound by all of these Terms of Use. IF
                      ...
                      a way that would violate the Gramm-Leach-Bliley Act (GLBA). The Site is
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      ...
                      expressly provided in these Terms of Use, no part of the Site and no Content
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      ...
                      you will not use the Site for any illegal or unauthorized purpose; and (7)
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      We accept payment through Stripe and all the payment methods enabled by stripe
                      are valid. You may be required to purchase or pay a fee to access some of our
                      ...
                      payments shall be in U.S. dollars. You agree to pay all charges or fees at the
                      prices then in effect for your purchases, and you authorize us to charge your
                      chosen payment provider for any such amounts upon making your purchase. If
                      your purchase is subject to recurring charges, then you consent to our
                    ...
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 ">6. Cancellation</h2>
                    <p className="mt-2 text-slate-600 text-[14px]">
                      All purchases are non-refundable. You can cancel your subscription at any by
                      sending us an email at admin@quicklook.me or from your accout itself under
                      billing settings. Your cancellation will take effect at the end of the current
                      paid term. If you are unsatisfied with our services, please email us at
                      admin@quicklook.me.
                    </p>
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6">
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      ...
                      by us. As a user of the Site, you agree not to: 1. Make any unauthorized use
                      ...
                      creating user accounts by automated means or under false pretenses. 2. Use a
                      buying agent or purchasing agent to make purchases on the Site. 3. Circumvent,
                      ...
                      therein. 4. Engage in unauthorized framing of or linking to the Site. 5.
                      Trick, defraud, or mislead us and other users, especially in any attempt to
                      learn sensitive account information such as user passwords. 6. Make improper
                      use of our support services or submit false reports of abuse or misconduct. 7.
                      Engage in any automated use of the system, such as using scripts to send
                      comments or messages, or using any data mining, robots, or similar data
                      gathering and extraction tools. 8. Interfere with, disrupt, or create an undue
                      burden on the Site or the networks or services connected to the Site. 9.
                      Attempt to impersonate another user or person or use the username of another
                      user. 10. Sell or otherwise transfer your profile. 11. Use any information
                      obtained from the Site in order to harass, abuse, or harm another person. 12.
                      ...
                      enterprise. 13. Decipher, decompile, disassemble, or reverse engineer any of
                      the software comprising or in any way making up a part of the Site. 14.
                      Attempt to bypass any measures of the Site designed to prevent or restrict
                      access to the Site, or any portion of the Site. 15. Harass, annoy, intimidate,
                      or threaten any of our employees or agents engaged in providing any portion of
                      the Site to you. 16. Delete the copyright or other proprietary rights notice
                      from any Content. 17. Copy or adapt the Site’s software, including but not
                      limited to Flash, PHP, HTML, JavaScript, or other code. 18. Upload or transmit
                      ...
                      posting of repetitive text), that interferes with any party’s uninterrupted
                      use and enjoyment of the Site or modifies, impairs, disrupts, alters, or
                      interferes with the use, features, functions, operation, or maintenance of the
                      Site. 19. Upload or transmit (or attempt to upload or to transmit) any
                      ...
                      or “pcms”). 20. Except as may be the result of standard search engine or
                      ...
                      unauthorized script or other software. 21. Disparage, tarnish, or otherwise
                      harm, in our opinion, us and/or the Site. 22. Use the Site in a manner
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      The Site does not offer users to submit or post content to public. We may
                      ...
                      represent and warrant that:1. The creation, distribution, transmission, public
                      ...
                      rights of any third party.2. You are the creator and owner of or have the
                      ...
                      Use.4. Your Contributions are not false, inaccurate, or misleading.5. Your
                      ...
                      or otherwise intended to protect the health or well-being of minors.13. Your
                      Contributions do not include any offensive comments that are connected to
                      race, national origin, gender, sexual preference, or physical handicap.14.
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      ...
                      Privacy Policy and your choices (including settings).By submitting suggestions
                    ...
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 "> 10. Submissions</h2>
                    <p className="mt-2 text-slate-600 text-[14px]">
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      These conditions are governed by and interpreted following the laws of India,
                      ...
                      residence. Quicklook and yourself both agree to submit to the non-exclusive
                      jurisdiction of the courts of New Delhi, which means that you may make a claim
                      to defend your consumer protection rights in regards to these Conditions of
                      Use in Belgium, or in the EU country in which you reside.
                    </p>
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 ">
                      {' '}
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      ...
                      dispute, controversy, or claim related to these Terms of Use (each a "Dispute"
                      ...
                      Party. Jurisdiction The parties agree that all disputes which need to be
                      settled in court, should fall within the jurisdiction of the courts located in
                      New Delhi, India. Restrictions The Parties agree that any arbitration shall be
                      ...
                      persons. Exceptions to Informal Negotiations and Arbitration The Parties agree
                    ...
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 "> 18. Corrections</h2>
                    <p className="mt-2 text-slate-600 text-[14px]">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 "> 19. Disclaimer</h2>
                    <p className="mt-2 text-slate-600 text-[14px]">
                    ...
                    <p className="mt-2 text-slate-600 text-[14px]">
                      ...
                      Terms of Use; (3) any breach of your representations and warranties set forth
                      in these Terms of Use; (4) your violation of the rights of a third party,
                    ...
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 "> 22. User data</h2>
                    <p className="mt-2 text-slate-600 text-[14px]">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-800 mt-6 "> 25. Contact us</h2>
                    <p className="mt-2 text-slate-600 text-[14px]">
