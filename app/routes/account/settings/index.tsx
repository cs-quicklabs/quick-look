        ...
        <div className='lg:grid lg:grid-cols-12 lg:gap-x-5 md:flex md:flex-wrap'>
          ...
          <div className="sm:px-6 md:w-3/5 lg:px-0 lg:col-span-9 lg:ml-64 xl:ml-60 2xl:ml-44 mt-2 font-inter max-w-3xl py-6 px-4 sm:p-6">
            ...
            <div className="py-6 px-6 sm:p-6 bg-gray-50 mt-20 md:mt-16 rounded-lg flex flex-col max-w-xl">
              ...
              <p className="text-sm font-normal leading-5 text-gray-500 max-w-lg mt-2">
                {loaderData?.profile?.isPublished ? 
                  <span> 
                    <span>
                      Unpublishing your account will hide your account temporarily and no one should be able to visit your profile from the link
                    </span>
                  ...
                  :
                  <span> 
                    Publishing your account will show your account and anyone should be able to visit your profile from the link <span className='font-[800]'>quicklook.me/{loaderData?.username}</span> . You can disable your profile anytime you want.
                  </span>
                }
              </p>
