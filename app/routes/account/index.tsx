  ...
  return (
    <div className='h-100vw '>
     ...
     ${mode === 'mobile' && loaderData?.profileInfo?.templateNumber == '5' ? 'lg:ml-[49rem] largeLaptop:ml-[24rem] medium:ml-[27rem]' : loaderData?.profileInfo?.templateNumber == '5' ? 'lg:ml-[24rem] largeLaptop:ml-[0rem] medium:ml-[3rem]' : null}`}>
      ...
      <Template1 primaryRestore={primaryRestore} secondaryRestore={secondaryRestore} input={input}  loaderData = {loaderData}/> : loaderData?.profileInfo?.templateNumber == '2' ? <Template3 mode={mode} primaryRestore={primaryRestore} secondaryRestore={secondaryRestore} input={input}  loaderData = {loaderData}/>  : loaderData?.profileInfo?.templateNumber == '3' ? <Template4 mode={mode} primaryRestore={primaryRestore} secondaryRestore={secondaryRestore} input={input}  loaderData = {loaderData}/> : loaderData?.profileInfo?.templateNumber == '4' ? <Template5 mode={mode} primaryRestore={primaryRestore} secondaryRestore={secondaryRestore} input={input}  loaderData = {loaderData}/> : loaderData?.profileInfo?.templateNumber == '5' ? <Template6 mode={mode} primaryRestore={primaryRestore} secondaryRestore={secondaryRestore} input={input}  loaderData = {loaderData}/> : null }</div>
        </div>
