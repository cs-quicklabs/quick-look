            ...
            <div className="pt-12 sm:pt-16 lg:pt-24">
                <div className="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto space-y-2 lg:max-w-none">
                        <h2 className="text-5xl leading-6 font-bold text-gray-300 uppercase tracking-wider pb-3">Pricing</h2>
                        <p className="text-lg font-extrabold text-white sm:text-4xl lg:text-5xl">The right price for you, whoever you are</p>
                                    ...
                                    <ul role="list" className="space-y-4">
                                        <li className="flex items-start">
                                            <div className="flex-shrink-0">    
                                                <svg className="h-6 w-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 divide-y divide-gray-200 sm:px-6 lg:py-16 lg:px-8">
                ...
                <div className="mt-8">
                    <dl className="divide-y divide-gray-200">
                        ...
                        <div className="pt-6 pb-8 md:grid md:grid-cols-12 md:gap-8">
                            <dt className="text-base font-medium text-gray-900 md:col-span-5">Lorem ipsum dolor sit amet consectetur, adipisicing elit?</dt>
                            <dd className="mt-2 md:mt-0 md:col-span-7">
                                <p className="text-base text-gray-500">Quod doloribus nemo maxime similique natus maiores omnis recusandae accusantium nulla cupiditate sit exercitationem eos nam reiciendis molestiae, odio ipsa saepe ducimus.</p>
                            </dd>
                        </div>
                        <div className="pt-6 pb-8 md:grid md:grid-cols-12 md:gap-8">
                            <dt className="text-base font-medium text-gray-900 md:col-span-5">Lorem ipsum dolor sit amet consectetur, adipisicing elit?</dt>
