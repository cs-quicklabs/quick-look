								...
								<div className="h-full relative ">
									<div className="absolute inset-0 border-gray-200 rounded-lg">
										<div className="">
											...
											<h1 className="text-base font-extrabold mt-5 sm:tracking-tight ">
													<span className="text-gray-400">CATEGORIES</span>
											</h1>
											<ul className="list-none list-inside mt-2 mb-5 text-sm font-semibold text-gray-500">
												<li>
													<Link to='#'>
														Free Pages
													</Link>
							...
							<div className=" py-6 px-4 sm:px-6 lg:px-8 ">
								<div className=" h-full ">
									<div className="relative inset-0 border-gray-200 rounded-lg">
										...
										<h2 className="text-lg font-semibold text-gray-800 mt-6">Last updated: 29/06/2022                                     
										</h2>
										<div className="mt-5">
											<p className="text-base text-gray-800"> You may request a refund within 3 days of your annual Pro purchase or Pro renewal.</p>
										...
										<p className="flex mt-2 text-base text-gray-800">
											...
											<Link to="#" className="ml-2 font-medium hover:text-indigo-500">
