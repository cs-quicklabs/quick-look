              ...
              <div className=' h-full '>
                <div className=' relative inset-0 border-gray-200 rounded-lg'>
                  ...
                  <p>
                    ...
                    <p className=''>Registration information </p>When you register for an
                  ...
                  <p className='mt-2 '>
                    ...
                    <p className=''>Deliver our services to you </p>
                    <p className=''>To improve your user experience</p>
                    <p className=''>To email you with essential product updates</p>
                    <p className=''>To troubleshoot product functionality and fix bugs</p>
                    <p className=''>To respond to legal requests or prevent fraud</p>
                  </p>
                  <h2 className='text-2xl font-semibold text-gray-800 mt-6 '>
                    4. Data we share
                  </h2>
