            ...
            <Form className='space-y-4' method='post' noValidate>
              <div className='grid grid-cols-2 gap-2'>
                <div className='relative'>
                  ...
                  <input
                    data-cy="firstName"
                    className={`flex items-center box-border appearance-none w-44 h-10 px-2.5 py-3.5 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm mt-1.5 ${actionData?.errors['firstname']
                ...
                <div className='relative'>
                  ...
                  <input
                    data-cy="lastName"
                    className={`flex items-center box-border appearance-none w-44 h-10 px-2.5 py-3.5 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm mt-1.5 ${actionData?.errors['lastname']
                        ? 'border border-red-400'
                        : 'first-line:'
                      }`}
                    type='lastName'
              ...
              <div className='relative'>
                ...
                <input
                  data-cy="email"
                  className={`box-border appearance-none block w-full h-10 px-2.5 py-3.5 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm mt-1.5 ${actionData?.errors['email'] ? 'border border-red-400' : ''
                    }`}
                  type='email'
                  name='email'
                  value={val.email}
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  className={`box-border appearance-none block w-full h-10 px-2.5 py-3.5 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm mt-1.5 ${actionData?.errors['isPasswordSame']
                      ? 'border border-red-400'
                      : ''
                    }`}
                  type='password'
