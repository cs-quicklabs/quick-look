              ...
              <div className='bg-white pt-10 sm:pt-16 lg:overflow-hidden lg:pt-16 lg:pb-14'>
                <div className='mx-auto max-w-7xl px-4 text-center sm:px-8'>
                  <h1 className='mt-4 mb-4 text-4xl font-extrabold tracking-tight text-gray-600 sm:mt-5 sm:text-6xl xl:text-6xl'>
                    ...
                    <span className='inline-block bg-gradient-to-r from-teal-400 to-blue-800 bg-clip-text text-transparent'>
                      Portfolio
                    </span>{' '}
                  ...
                  <div className='my-12 md:mt-20'>
                    <img
                      ...
                      src='https://about.me/s3/h/z/aboutme-desktop.d642444f.png'
                    ...
                    <div className='relative z-10 mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left'>
                      <div className='lg:py-24'>
                        <p className='text-base text-gray-600 sm:text-xl lg:text-lg xl:text-xl'>
                          ...
                          elit. Iste ut deserunt quibusdam fuga architecto nam
                          mollitia dolorum. Error quo, eaque, nostrum veritatis
                          recusandae adipisci dolorem ratione a laborum quasi
                          enim!
                        </p>
                        ...
                        <div className='mt-2'>
                          <div className='sm:flex'>
                            <div className='mt-3 flex items-center justify-center space-x-2 sm:mt-0'>
                              <Link
                                to='/beta'
                                className='block w-full rounded-md bg-gray-800 py-3 px-4 text-center font-medium text-white shadow hover:bg-gray-600'
                              >
                                Get your free page
                              </Link>
                            </div>
                        ...
                        <div className='mt-2'>
                          <div className='sm:flex'>
                            ...
                            <p className='ml-3 mt-3 text-sm text-gray-600 sm:mt-4'>
                              Lorem ipsum{' '}
                              <span className='bg-gray-800 to-cyan-600 px-2 font-semibold text-white'>
                                SALE
                              </span>{' '}
                              (Lorem ipsum: $29)
                            </p>
                      ...
                      <div className='glowing mx-auto flex max-w-md items-center justify-center px-2 py-20 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0'>
                        <div className='relative z-20'>
                          <div className='relative cursor-pointer'>
                            <img
                              className='translate-x-6 skew-y-1 aspect-[1192/1404] absolute top-5 -left-5 with-loading-placeholder z-10 mx-auto transform rounded-xl border border-gray-500 shadow transition-all hover:scale-105 hover:ease-[cubic-bezier(.4,0,.2,1)]'
                              width='400'
                              src='https://about.me/s3/h/z/google_analytics.6c305716.jpg'
                              alt='image 1'
                            />
                            <img
                              className='translate-x-5 skew-y-1 aspect-[1192/1404] with-loading-placeholder relative mx-auto transform rounded-xl border border-gray-500 shadow transition-all hover:z-20 hover:scale-105 hover:ease-[cubic-bezier(.4,0,.2,1)]'
                              width='400'
                              src='https://about.me/s3/h/z/professional-desktop.46306085.jpg'
                              alt='image 2'
                            />
                          </div>
                        </div>
                  ...
                  <div className='flex flex-col rounded-lg shadow-lg overflow-hidden'>
                    ...
                    <div className='flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6'>
                      ...
                      <div className='rounded-md shadow'>
                        <Link
                          to='#'
                          className='flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-800 hover:bg-gray-600'
