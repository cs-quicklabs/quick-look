describe("Add testimonial test cases", function () {
  ...
  it("Should be able to add testimonial", () => {
    ...
    cy.contains("Testimonial");
    cy.get('[data-cy="testimonialText"]').type("Hello, everyone! I'm Bella Rodriguez and today's post is sponsored by Bold and Beautiful Cosmetics. This is a vegan cosmetics brand owned and operated by a woman of color! and I'm going to show them off to you. This first one is a cherry red.");
    cy.contains("Name of the person who gave this testimonial");
  ...
  it("Should be able to edit testimonial", () => {
    ...
    cy.contains("Please provide link of video you would like to show on profile");
    cy.get('[data-cy="editTestimonialButton"]').click();

    cy.contains("Edit Testimonial to your profile");
    cy.contains("Add, edit or delete testimonial from your profile");
    cy.contains("Edit Testimonial");
    cy.get('[data-cy="testimonialEditText"]').clear().type("Hello, everyone! I'm Bella Rodriguez and today's post is sponsored by Bold and Beautiful Cosmetics.");
    cy.contains("Name of the person who gave this testimonial");
    cy.get('[data-cy="testimonialEditBy"]').type('{backspace}').type('{backspace}').type('{backspace}');
