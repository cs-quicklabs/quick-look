describe("Add testimonial test cases", function () {
  ...
  it("Should be able to add Video Link", () => {
    ...
    cy.contains("Please provide link of video you would like to show on profile");
    cy.contains("Add Link");
    cy.get('[data-cy="addVideoLink"]').type("https://www.youtube.com/watch?v=leo1FZ6vu1I");
  ...
  it("Should be able to edit Video Link", () => {
    ...
    cy.get('[data-cy="editVideoLink"]').clear().type("https://www.youtube.com/watch?v=fmIiDLbLc_s");
