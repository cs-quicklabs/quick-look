...
var tailwind_default = "/build/_assets/tailwind-DPHQSOKG.css";
...
var FormikInput = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    autoComplete: "off"
  })), (props == null ? void 0 : props.xyz) && /* @__PURE__ */ React.createElement("label", {
    htmlFor: field.name,
    className: "w-24 pl-2 inset-x-0 top-10 absolute sm:text-sm"
  }, props.xyz), /* @__PURE__ */ React.createElement(import_formik.ErrorMessage, {
...
function Refund() {
  ...
  }, /* @__PURE__ */ React.createElement("li", null, "Email address associated with your quicklook.me page"), /* @__PURE__ */ React.createElement("li", null, "Link to your quicklook.me page (quicklook.me/yourusername)"), /* @__PURE__ */ React.createElement("li", null, "Date of purchase or renewal (if you have a screenshot of the receipt, even better!)"), /* @__PURE__ */ React.createElement("li", null, 'The word "REFUND" in the body of your email')), /* @__PURE__ */ React.createElement("p", {
    className: "mt-2 text-base text-gray-800"
...
function privacy() {
  ...
  }, "Send us an email", /* @__PURE__ */ React.createElement("br", null), "admin@quicklook.me")))))), /* @__PURE__ */ React.createElement("div", {
    className: "bg-white lg:min-w-0 lg:flex-1"
  }, /* @__PURE__ */ React.createElement("div", {
    className: " py-6 px-4 sm:px-6 lg:px-8 "
  }, /* @__PURE__ */ React.createElement("div", {
...
function terms() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
    ...
    className: "text-2xl font-semibold text-gray-800 mt-6 "
  }, "6. Cancellation"), /* @__PURE__ */ React.createElement("p", null, "All purchases are non-refundable. You can cancel your subscription at any by sending us an email at admin@quicklook.me or from your accout itself under billing settings. Your cancellation will take effect at the end of the current paid term. If you are unsatisfied with our services, please email us at admin@quicklook.me."), /* @__PURE__ */ React.createElement("h2", {
    className: "text-2xl font-semibold text-gray-800 mt-6"
    ...
    className: "mt-2 text-base text-gray-800"
  }, "These conditions are governed by and interpreted following the laws of India, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. Quicklook and yourself both agree to submit to the non-exclusive jurisdiction of the courts of New Delhi, which means that you may make a claim to defend your consumer protection rights in regards to these Conditions of Use in Belgium, or in the EU country in which you reside."), /* @__PURE__ */ React.createElement("h2", {
    className: "text-2xl font-semibold text-gray-800 mt-6 "
    ...
    className: "mt-2 text-base text-gray-800"
  }, "In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at: admin@quicklook.me"))))))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", {
    className: "max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between"
  }, /* @__PURE__ */ React.createElement("h2", {
    className: "text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl"
  }, /* @__PURE__ */ React.createElement("span", {
